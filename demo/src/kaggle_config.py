...
# Kaggle input paths
VIMEDNER_ADAPTER_PATH = "/kaggle/input/model-zip/qwen2p5_3b_vimedner_ner_lora/qwen2p5_3b_vimedner_ner_lora"
VIMQ_ADAPTER_PATH = "/kaggle/input/model-zip/qwen2p5_3b_vimq_ner_lora/qwen2p5_3b_vimq_ner_lora"
